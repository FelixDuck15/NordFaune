...
\begin{table}[htp]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        \ref{resistance_neige} Résistance aux effets de l'enfouissement sous la neige & 10\% & Voir barème \ref{resistance_neige} & 0 & 100 \\
        \ref{installation_deploiement} Difficulté d’installation et de déploiement & 5\% & $\frac{G-1}{M}$ & 0 & \\
        \ref{resistance_neige} Résistance aux effets de l'enfouissement sous la neige & 15\% & $\sqrt{x}$ & 10 & \\
        ...
        \ref{exploitation_scientifique} Qualité scientifique des données & 5\% & $\frac{f-15}{15}$ & 10 & 50 \\
