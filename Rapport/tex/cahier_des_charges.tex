...
\subsection{Résistance aux effets de l'enfouissement sous la neige}
...
\begin{table}[htp]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        \ref{fiabilite} Fiabilité de la supervison à distance & 6\% & $F = ln(t+1)$ & 10 & 50 \\
        ...
        \ref{resistance_neige} Résistance aux effets de l'enfouissement sous la neige & 10\% & Voir barème \ref{resistance_neige} & 10 & 50 \\
        \ref{installation_deploiement} Difficulté d’installation et de déploiement & 5\% & Voir barème \ref{installation_deploiement} & 10 & 50 \\
        \ref{resistance_neige} Résistance aux effets de l'enfouissement sous la neige & 15\% & Voir barème \ref{resistance_neige} & 10 & 50 \\
        
        \hline
        \ref{donnees} Assurer observation et gestion de données & & &  &  \\
        \ref{detection_mammiferes} Performance de détection faunique & 9\% & Voir barème \ref{detection_mammiferes} & 10 & 50 \\
        \ref{conservation_donnees} Pérennité du stockage des données & 5\% & $\frac{d-12}{12}$ & 10 & 50 \\
        \ref{performance_communication} Performance de communication distante & 6\% & $\frac{x-2000}{2000}$ & 10 & 50 \\
